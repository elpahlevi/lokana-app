    ...
    <Modal
      ...
      nestedModal={
        <SuccessModal
          ...
          message="Your request has been submitted successfully. You can check the status on Dashboard page"
        ...
        <form onSubmit={handleSubmit}>
                ...
                return (
                  <label className="inline-flex items-center gap-2" key={index}>
                    <input
                      ...
                      type="checkbox"
                      value={item}
                      className="rounded text-blue-600 focus:ring-transparent"
          ...
          <div className="mb-2">
            ...
            <div
              ...
              {...register("format")}
            >
              {format.map(({ placeholder, value }, index) => {
                return (
                  <label className="inline-flex items-center gap-2" key={index}>
                    <input
                      key={index}
                      type="radio"
                      className="text-blue-600 focus:ring-transparent"
                      name="format"
                      value={value}
                    />
          ...
          <div className="flex justify-between items-center mt-4">
            <button
              type="button"
              className="inline-flex justify-start px-4 py-2 text-sm font-medium text-blue-900 border border-transparent rounded-md hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 select-none"
              onClick={onCancel}
            >
              Cancel
            </button>
            <button
              type="submit"
              className={`inline-flex justify-end px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 select-none ${
...
export default WrfgenRequestForm;
